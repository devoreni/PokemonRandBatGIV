...
if __name__ == '__main__':
    ...
    pk1 = root.pokesets['Mew']
    pk2 = root.pokesets['Mew']
    pk3 = root.pokesets['Mew']
    pk4 = root.pokesets['Mew']
    pk5 = root.pokesets['Mew']
    pk6 = root.pokesets['Mew']
    pk7 = root.pokesets['Mew']
    pk8 = root.pokesets['Mew']
    pk9 = root.pokesets['Mew']
    pk0 = root.pokesets['Mew']
