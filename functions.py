...
if __name__ == '__main__':
    ...
    pk1 = root.pokesets['Slowking']
    pk2 = root.pokesets['Slowking']
    pk3 = root.pokesets['Slowking']
    pk4 = root.pokesets['Slowking']
    pk5 = root.pokesets['Slowking']
    pk6 = root.pokesets['Slowking']
    pk7 = root.pokesets['Slowking']
    pk8 = root.pokesets['Slowking']
    pk9 = root.pokesets['Slowking']
    pk0 = root.pokesets['Slowking']
