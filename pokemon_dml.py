...
def runDML():
    ...
    if 'Pokemon':
        if 'Venusaur':
            root.pokesets['Venusaur'] = (
                pokemon_ddl.PokemonSet('Venusaur',
                                       'Venusaur',
                                       ('Overgrow',),
                                       ('Grass', 'Poison'),
                                       (pokemon_ddl.MoveSet(
                                           ('Giga Drain', 'Frenzy Plant'),
                                           {'Frenzy Plant': ['Sludge Bomb'],'Giga Drain':['Sludge Bomb']}),),
                                       ('Frenzy Plant', 'Giga Drain', 'Sludge Bomb', 'Protect'),
                                       (80, 82, 83, 100, 100, 80)))
